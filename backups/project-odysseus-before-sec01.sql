...
CREATE POLICY "community_answers_select" ON "public"."community_answers" FOR SELECT USING ((("moderation_state" = 'visible'::"public"."community_moderation_state") OR ("profile_id" = "public"."current_profile_id"()) OR ("public"."current_profile_role"() = ANY (ARRAY['admin'::"public"."user_role", 'tutor'::"public"."user_role"]))));
...
CREATE POLICY "community_challenge_submissions_select_own" ON "public"."community_challenge_submissions" FOR SELECT USING (("profile_id" = "public"."current_profile_id"()));
...
CREATE POLICY "community_challenges_read_authenticated" ON "public"."community_challenges" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "community_questions_select" ON "public"."community_questions" FOR SELECT USING ((("moderation_state" = 'visible'::"public"."community_moderation_state") OR ("profile_id" = "public"."current_profile_id"()) OR ("public"."current_profile_role"() = ANY (ARRAY['admin'::"public"."user_role", 'tutor'::"public"."user_role"]))));
...
CREATE POLICY "community_room_members_select_own" ON "public"."community_room_members" FOR SELECT USING (("profile_id" = "public"."current_profile_id"()));
...
CREATE POLICY "community_room_messages_select_member" ON "public"."community_room_messages" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM "public"."community_room_members" "m"
  WHERE (("m"."room_id" = "community_room_messages"."room_id") AND ("m"."profile_id" = "public"."current_profile_id"())))) AND (("moderation_state" = 'visible'::"public"."community_moderation_state") OR ("public"."current_profile_role"() = ANY (ARRAY['admin'::"public"."user_role", 'tutor'::"public"."user_role"])))));
...
CREATE POLICY "community_rooms_read_authenticated" ON "public"."community_study_rooms" FOR SELECT USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "tutors_insert_subjects" ON "public"."subjects" FOR INSERT WITH CHECK (("public"."current_profile_role"() = 'tutor'::"public"."user_role"));



CREATE POLICY "tutors_manage_own_assignments" ON "public"."assignments" USING ((("public"."current_profile_role"() = 'tutor'::"public"."user_role") AND ("created_by" = "public"."current_profile_id"()))) WITH CHECK ((("public"."current_profile_role"() = 'tutor'::"public"."user_role") AND ("created_by" = "public"."current_profile_id"())));
...
CREATE POLICY "tutors_select_own_application" ON "public"."tutor_applications" FOR SELECT USING (("tutor_id" = "public"."current_tutor_id"()));



CREATE POLICY "tutors_select_own_assignment_submissions" ON "public"."assignment_submissions" FOR SELECT USING ((("public"."current_profile_role"() = 'tutor'::"public"."user_role") AND ("assignment_id" IN ( SELECT "a"."id"
   FROM "public"."assignments" "a"
  WHERE ("a"."created_by" = "public"."current_profile_id"())))));



CREATE POLICY "tutors_select_own_availability_slots" ON "public"."tutor_availability_slots" FOR SELECT USING (("tutor_id" = "public"."current_tutor_id"()));



CREATE POLICY "tutors_select_own_documents" ON "public"."tutor_documents" FOR SELECT USING (("tutor_id" = "public"."current_tutor_id"()));
...
GRANT ALL ON FUNCTION "public"."anonymize_student"("p_student_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."anonymize_student"("p_student_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."community_study_rooms" TO "anon";
GRANT ALL ON TABLE "public"."community_study_rooms" TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."create_study_room"("p_subject" "text", "p_grade" "text") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."current_tutor_id"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_community_challenges"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_community_questions"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_community_rooms"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_room_messages"("p_room_id" "uuid") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."join_study_room"("p_room_id" "uuid") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."moderate_community_text"("p_content" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."moderate_community_text"("p_content" "text") TO "authenticated";
...
GRANT ALL ON TABLE "public"."community_room_messages" TO "anon";
GRANT ALL ON TABLE "public"."community_room_messages" TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."post_room_message"("p_room_id" "uuid", "p_content" "text") TO "authenticated";
...
GRANT ALL ON TABLE "public"."community_answers" TO "anon";
GRANT ALL ON TABLE "public"."community_answers" TO "authenticated";
GRANT ALL ON TABLE "public"."community_answers" TO "service_role";



GRANT ALL ON TABLE "public"."community_challenge_submissions" TO "anon";
GRANT ALL ON TABLE "public"."community_challenge_submissions" TO "authenticated";
...
GRANT ALL ON TABLE "public"."community_room_members" TO "anon";
GRANT ALL ON TABLE "public"."community_room_members" TO "authenticated";
