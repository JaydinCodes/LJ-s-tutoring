...
export const dashboardSurfaceClass = 'rounded-[1.25rem] border border-white/70 bg-white/[0.78] p-4 shadow-[0_18px_45px_rgba(15,23,42,0.07)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/25 sm:rounded-[1.5rem] sm:p-5';
